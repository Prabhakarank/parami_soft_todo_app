...
describe DashboardsController do
  ...
  let(:valid_attributes) { { "admin" => "MyString" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved dashboard as @dashboard" do
        ...
        post :create, {:dashboard => { "admin" => "invalid value" }}, valid_session
        assigns(:dashboard).should be_a_new(Dashboard)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested dashboard" do
        ...
        Dashboard.any_instance.should_receive(:update).with({ "admin" => "MyString" })
        put :update, {:id => dashboard.to_param, :dashboard => { "admin" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the dashboard as @dashboard" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Dashboard.any_instance.stub(:save).and_return(false)
        put :update, {:id => dashboard.to_param, :dashboard => { "admin" => "invalid value" }}, valid_session
        assigns(:dashboard).should eq(dashboard)
      end
